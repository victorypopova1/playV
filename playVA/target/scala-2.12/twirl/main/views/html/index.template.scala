...
object index extends _root_.play.twirl.api.BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,_root_.play.twirl.api.Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with _root_.play.twirl.api.Template2[String,List[Feature],play.twirl.api.HtmlFormat.Appendable] {

  /**/
  def apply/*1.2*/(message: String)(all: List[Feature]):play.twirl.api.HtmlFormat.Appendable = {
    _display_ {
      {
...
<section id="hero-text" class="wow fadeIn">
    <section id="services2">
        ...
        <div class="container">
            <div class="row">
                """),_display_(/*73.18*/for(feature <- all.asScala) yield /*73.45*/{_display_(Seq[Any](format.raw/*73.46*/("""
                """),format.raw/*74.17*/("""<div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        <i class=""""),_display_(/*76.36*/feature/*76.43*/.imageUrl),format.raw/*76.52*/(""""></i>
                        <h3>"""),_display_(/*77.30*/feature/*77.37*/.title),format.raw/*77.43*/("""</h3>
                        <p>"""),_display_(/*78.29*/Html(feature.description)),format.raw/*78.54*/("""</p>
                    </div>
                </div>
            </div>
            """)))}),format.raw/*82.14*/("""
...
"""))
  ...
  def render(message:String,all:List[Feature]): play.twirl.api.HtmlFormat.Appendable = apply(message)(all)

  def f:((String) => (List[Feature]) => play.twirl.api.HtmlFormat.Appendable) = (message) => (all) => apply(message)(all)
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Sat Nov 11 14:54:19 IRKT 2017
                  SOURCE: E:/web/playVA/playVA/app/views/index.scala.html
                  HASH: 9657b1987af0db6e643a68d92bd1184cbfd80eb5
                  MATRIX: 962->1|1094->38|1121->39|4016->2907|4059->2934|4098->2935|4143->2952|4295->3077|4311->3084|4341->3093|4404->3129|4420->3136|4447->3142|4508->3176|4554->3201|4672->3288|4708->3297
                  LINES: 28->1|33->1|34->2|105->73|105->73|105->73|106->74|108->76|108->76|108->76|109->77|109->77|109->77|110->78|110->78|114->82|115->83
                  -- GENERATED --
              */
